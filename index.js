...
const { HfInference } = require('@huggingface/inference'); // 1. استدعاء الحزمة الجديدة
...
// 2. تهيئة Hugging Face باستخدام المفتاح الجديد
const hf = new HfInference(process.env.HF_TOKEN);

// 3. تحديد اسم النموذج الذي تريده بالضبط
...
app.post('/analyze', async (req, res) => {
  ...
  try {
    // 4. بناء الـ Prompt بالطريقة الصحيحة لنموذج Mistral
